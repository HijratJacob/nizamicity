...
jQuery(document).ready(function() {
	...
	if ($('.togo-header').length) {
		...
		var togoHeader = $('.togo-header'),
			...
			togoMenuListWrapper = $('.togo-menu > ul'),
			togoMenuListDropdown = $('.togo-menu ul li:has(ul)'),
	...
	if ($('.togo-header-overlay').length) {
		...
		var togoHeaderOverlay = $('.togo-header-overlay'),
			togoMenuOverlay = $('.togo-menu-overlay'),
	...
	if ($('.togo-fixed-sidebar').length) {
		var togoFixedSidebar = $('.togo-fixed-sidebar'),
			togoMenuFixed = $('.togo-menu-fixed'),
			togoSideContent = $('.togo-side-content'),
		...
		$('.togo-fixed-sidebar .logo, .togo-menu-fixed').wrapAll('<div class="fixed-menu-wrap"></div>');
